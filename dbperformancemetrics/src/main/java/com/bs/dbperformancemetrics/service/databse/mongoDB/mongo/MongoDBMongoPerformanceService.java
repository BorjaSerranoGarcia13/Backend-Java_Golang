...
public class MongoDBMongoPerformanceService implements IDatabasePerformanceService {
    ...
    public MongoDBMongoPerformanceService(MongoDBUserUploader userUploader, MongoDBUserMongoServiceImp userService, PerformanceResultModifier performanceResultModifier) {
